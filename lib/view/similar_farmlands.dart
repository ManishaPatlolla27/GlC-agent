...
class SimilarFarmlandScreen extends StatefulWidget {
  const SimilarFarmlandScreen({super.key});

  @override
  State<SimilarFarmlandScreen> createState() => _SimilarFarmlandScreentate();
}

class _SimilarFarmlandScreentate extends State<SimilarFarmlandScreen> {
  List<FarmLandList> farmlandSections = [];
  late String seeall =
      "Similar FarmLands"; // Default value to prevent null errors
