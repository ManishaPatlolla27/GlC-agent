...
class ProfileMenuRepository {
  ...
  Future<List<ProfileMenuList>> getprofilemenu() async {
    try {
      ...
      final response = await _apiClient.get<Profilemenuresponse>(
        ApiConstants.profilemenu,
        fromJson: (json) => Profilemenuresponse.fromJson(json as List<dynamic>),
        headers: headers,
      );
